(function(){
  ...
  const i18n = {
    de: {
      ...
      hero_title:"Websites und Logos, die <em>Ihr Unternehmen</em> professionell wirken lassen — egal wo Sie leben.",
    ...
    fr: {
      ...
      hero_title:"Des sites web et logos qui donnent à <em>votre entreprise</em> une image professionnelle — où que vous soyez.",
    ...
    en: {
      ...
      hero_title:"Websites and logos that make <em>your business</em> look professional — wherever you are.",
